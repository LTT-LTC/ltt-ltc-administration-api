            ...
            Configure<AbpVirtualFileSystemOptions>(options =>
            {
                options.FileSets.ReplaceEmbeddedByPhysical<AdministrationServiceDomainSharedModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}LTC.AdministrationService.Domain.Shared"));
                options.FileSets.ReplaceEmbeddedByPhysical<AdministrationServiceDomainModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}LTC.AdministrationService.Domain"));
                options.FileSets.ReplaceEmbeddedByPhysical<AdministrationServiceApplicationContractsModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}LTC.AdministrationService.Application.Contracts"));
                options.FileSets.ReplaceEmbeddedByPhysical<AdministrationServiceApplicationModule>(
                    Path.Combine(hostingEnvironment.ContentRootPath,
                        $"..{Path.DirectorySeparatorChar}src{Path.DirectorySeparatorChar}LTC.AdministrationService.Application"));
            });
        }
    }
