...
{
    public class AdminCinemaAppService : ApplicationService, IAdminCinemaAppService
    {
        private readonly IRepository<Entities.Cinema, Guid> _cinemaRepository;

        public AdminCinemaAppService(IRepository<Entities.Cinema, Guid> cinemaRepository)
        {
