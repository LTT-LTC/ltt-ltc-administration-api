...
{
    [ApiController]
    [Route("ltc/administration-service/api/administration/admin/seat-type")]
    public class AdminSeatTypeController : AbpControllerBase
    {
        private readonly IAdminSeatTypeAppService _appService;

        public AdminSeatTypeController(IAdminSeatTypeAppService appService)
        {
