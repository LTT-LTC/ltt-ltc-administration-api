...
namespace LTC.AdministrationService.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("AdministrationService") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "AdministrationService", DisplayName = "AdministrationService API", Resources = { "AdministrationService" }
            });
        }
    }
